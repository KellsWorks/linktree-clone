  ...
  return (
    <div className="w-full grid grid-cols-5">
      ...
      <div className="col-span-3 order-1">
        ...
        <div className="px-10 py-10 mx-auto max-w-3xl justify-center space-y-6">
          ...
          <div className="relative">
            ...
            <input value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" type="text" className="bg-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-20 p-4" />
          </div>
