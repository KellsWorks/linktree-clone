...
import RightSideImage from '../../assets/login_side_right.png';
  ...
  return (
    ...
    <div className="w-full grid grid-cols-5">
      ...
      <div className="col-span-3 order-1">
        ...
        <form onSubmit={(e) => handleLogin(e)} className="px-10 py-10 mx-auto max-w-3xl justify-center space-y-6">

          <h3 className='text-5xl font-bold'>Log in to your Linktree</h3>

          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-gray-500">
              linktr.ee/
            </div>
            <input required value={username} onChange={(e) => setUsername(e.target.value)} placeholder="yourname" type="text" className="bg-gray-100 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-20 p-4" />
          </div>
          ...
          <div>
            <Link to={'#'} className='text-purple-600 underline font-normal text-sm'>
          ...
          <div className='flex items-center space-x-1 justify-center'>
            ...
            <Link to={'/register'} className='text-purple-600 underline font-normal text-sm'>
              Sign up
            </Link>
          </div>
        </form>
